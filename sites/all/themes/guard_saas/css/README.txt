...
To use these stylesheets, rename the files and guard_saas with the name of your theme.
...
guard_saas-alpha-default-narrow.css  
...
guard_saas-alpha-default-normal.css
...
guard_saas-alpha-default-wide.css
